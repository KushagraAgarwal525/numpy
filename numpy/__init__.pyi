...
# ``__pos__`` accepts bool arrays (gh-32100); ``__neg__`` does not.
type _ArrayPosable = NDArray[number | timedelta64 | object_ | bool_]
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def __pos__[ArrayT: _ArrayPosable](self: ArrayT, /) -> ArrayT: ...
